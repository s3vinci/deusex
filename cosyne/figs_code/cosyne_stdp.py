...
from chapter1.figs_code.plot_functions import *
import time
import matplotlib
...
def calculate_da_app(t):
    ...
    da_app_vinf = (da_gleak * da_vrest + da_gex * da_vex + da_ginh * -70) / da_app_gtotal
...
def calculate_da_ave(t):
    ...
    da_app_vinf = (da_gleak * da_vrest + da_gex * da_vex + da_ginh * -70) / da_ave_gtotal
