...
sp_times = np.sort(np.random.randint(low=start_odor, high=m_duration, size=(n_kc_active, 3* odor_duration_s)))
...
ax.annotate('Odour start',arrowprops=dict(facecolor='black',arrowstyle="->"), xy=(0.1, -0.1), xytext=(-15, -20), va='top', xycoords='axes fraction', textcoords='offset points',fontsize=fontsize)
ax.annotate('Odour end',arrowprops=dict(facecolor='black', arrowstyle="->"), xy=(1, -0.1), xytext=(-15, -20), va='top', xycoords='axes fraction', textcoords='offset points',fontsize=fontsize)
...
ax.annotate('Shock start',arrowprops=dict(facecolor='black', arrowstyle="->"), xy=(0.1, -0.1), xytext=(-15, -20), va='top', xycoords='axes fraction', textcoords='offset points',fontsize=fontsize)

ax.annotate('Shock end',arrowprops=dict(facecolor='black', arrowstyle="->"), xy=(0.9, -0.1), xytext=(-15, -20), va='top', xycoords='axes fraction', textcoords='offset points',fontsize=fontsize)
